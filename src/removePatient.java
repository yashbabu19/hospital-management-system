...
public class removePatient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Fill Patient ID To Remove Patient");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String sql1="delete from patientreport where patientID='"+patientID+"'";
        String sql2="delete from patient where patientID='"+patientID+"'";
  ...
  if(a==0)
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try
        {
            Connection con=connectionProvider.getCon();
            Statement st=con.createStatement();
            ResultSet rs=st.executeQuery("select patientID,name,contactNumber,age,gender from patient");
